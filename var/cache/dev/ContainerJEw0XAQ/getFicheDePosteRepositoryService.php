 ...
 */
class getFicheDePosteRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\FicheDePosteRepository' shared autowired service.
     *
     * @return \App\Repository\FicheDePosteRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'FicheDePosteRepository.php';

        return $container->privates['App\\Repository\\FicheDePosteRepository'] = new \App\Repository\FicheDePosteRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
